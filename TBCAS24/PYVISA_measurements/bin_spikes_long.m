...
name = 'test_rw_N3b_itail_0-2023-09-06_20-27-59_sorted'
%% bin into windows
trial=1;
chunks=0;
if chunks==0
...
saveas(gcf,['output\spike_frames_bin_',name,'-',num2str(trial),'.fig'])
saveas(gcf,['output\spike_frames_bin_',name,'-',num2str(trial),'.png'])
%% heatmap
...
set(gcf, 'Position', [100, 100, width, height]);
saveas(gcf,['output\spike_frames_',name,'-',num2str(trial),'.fig'])
saveas(gcf,['output\spike_frames_',name,'-',num2str(trial),'.png'])