...
system('"C:\Users\iclab\Documents\MARK\intuitive_journal\arduino-cli_0.29.0_Windows_64bit\arduino-cli" board list')
cmd1 = ['"C:\Users\iclab\Documents\MARK\intuitive_journal\arduino-cli_0.29.0_Windows_64bit\arduino-cli" compile --fqbn teensy:avr:teensy41 "C:\Users\iclab\Documents\MARK\intuitive_journal\arduino_ino_files\fastAER_imode_sensorized_teensy\fastAER_imode_sensorized_teensy.ino"']
system(cmd1)

cmd2 = ['"C:\Users\iclab\Documents\MARK\intuitive_journal\arduino-cli_0.29.0_Windows_64bit\arduino-cli" upload  -p COM5 --fqbn teensy:avr:teensy41 "C:\Users\iclab\Documents\MARK\intuitive_journal\arduino_ino_files\fastAER_imode_sensorized_teensy\fastAER_imode_sensorized_teensy.ino"']
system(cmd2)
...
%name = ['sensor_test_1b_pdms_N5b_itail_50nA_rampinput_0p1Hz_500mVpp','-',datestr_name]
...
if spk_data(1) == 'S'
    ...
    if src.UserData.Count > 800*1 -1    %499
