...
h(end+1)=scatter(spike_rate_imode_vil_0p875_tmaxms(end), results_max_imode_vil_0p875_hsize_242_tmaxms_arr(end), 100, 'filled', 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r');
...
h(end+1)=scatter(spike_rate_imode_vil_0p925_tmaxms(end), results_max_imode_vil_0p925_hsize_242_tmaxms_arr(end), 100, 'filled', 'Marker', '*', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r');




lgd = legend('N=3b (hidden layer=234','N=4b (hidden layer=234','N=5b (hidden layer=234','N=3b (hidden layer=242','N=4b (hidden layer=242','N=5b (hidden layer=242','N=3b (OFF discarded; hidden layer=242','N=4b (OFF discarded; hidden layer=242','N=5b (OFF discarded; hidden layer=242','N=3b (OFF merged; hidden layer=242','N=4b (OFF merged; hidden layer=242','N=5b (OFF merged; hidden layer=242','vil=0.875V (hidden layer=242','vil=0.9V (hidden layer=242','vil=0.925V (hidden layer=242')
...
h(end+1)=scatter(spike_rate_imode_vil_0p875_tmaxms(end), results_linear_maxfold_imode_vil_0p875_hsize_242_tmaxms_arr(end), 100, 'filled', 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r');
...
h(end+1)=scatter(spike_rate_imode_vil_0p925_tmaxms(end), results_linear_maxfold_imode_vil_0p925_hsize_242_tmaxms_arr(end), 100, 'filled', 'Marker', '*', 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'r');
