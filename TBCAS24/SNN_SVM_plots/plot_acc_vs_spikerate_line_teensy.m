...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_180mvpp_tmaxms(end) spike_rate_imode_vil_0p9_180mvpp_tmaxms(end) spike_rate_imode_vil_1_180mvpp_tmaxms(end)], [ mean(results_max_imode_vil_0p8_180mvpp_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_0p9_180mvpp_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_1_180mvpp_hsize_242_tmaxms(end,:))],[ std(results_max_imode_vil_0p8_180mvpp_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_0p9_180mvpp_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_1_180mvpp_hsize_242_tmaxms(end,:)) ],'-o','Color','r','LineWidth',3);

h(end+1)=errorbar([spike_rate_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_tmaxms(end) spike_rate_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_tmaxms(end)], [mean(results_max_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:))],[std(results_max_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) ],'-o','Color','y','LineWidth',3);

h(end+1)=errorbar([spike_rate_imode_vil_0p8_18mvpp_tmaxms(end)], [ mean(results_max_imode_vil_0p8_18mvpp_hsize_242_tmaxms(end,:)) ],[ std(results_max_imode_vil_0p8_18mvpp_hsize_242_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);

% 
% h(end+1)=errorbar([spike_rate_imode_vil_0p7_ith_9p375n_ispike_100n_tmaxms(end) spike_rate_imode_vil_0p8_ith_9p375n_ispike_100n_tmaxms(end) spike_rate_imode_vil_0p7_tmaxms(end) spike_rate_imode_vil_0p775_tmaxms(end) spike_rate_imode_vil_0p9_tmaxms(end)], [ mean(results_max_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_0p7_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_0p775_hsize_242_tmaxms(end,:)) mean(results_max_imode_vil_0p9_hsize_242_tmaxms(end,:))],[ std(results_max_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_0p7_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_0p775_hsize_242_tmaxms(end,:)) std(results_max_imode_vil_0p9_hsize_242_tmaxms(end,:))],'-o','Color','r','LineWidth',3);
...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_180mvpp_tmaxms(end) spike_rate_imode_vil_0p9_180mvpp_tmaxms(end) spike_rate_imode_vil_1_180mvpp_tmaxms(end)], [ mean(results_linear_maxfold_imode_vil_0p8_180mvpp_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_0p9_180mvpp_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_1_180mvpp_hsize_242_tmaxms(end,:))],[ std(results_linear_maxfold_imode_vil_0p8_180mvpp_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_0p9_180mvpp_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_1_180mvpp_hsize_242_tmaxms(end,:)) ],'-o','Color','r','LineWidth',3);

h(end+1)=errorbar([spike_rate_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_tmaxms(end) spike_rate_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_tmaxms(end)], [mean(results_linear_maxfold_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:))],[std(results_linear_maxfold_imode_vil_0p9_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_1_180mvpp_ith_9p375n_ispk_1p4u_hsize_242_tmaxms(end,:)) ],'-o','Color','y','LineWidth',3);

h(end+1)=errorbar([spike_rate_imode_vil_0p8_18mvpp_tmaxms(end)], [ mean(results_linear_maxfold_imode_vil_0p8_18mvpp_hsize_242_tmaxms(end,:)) ],[ std(results_linear_maxfold_imode_vil_0p8_18mvpp_hsize_242_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);

% h(end+1)=errorbar([spike_rate_imode_vil_0p7_ith_9p375n_ispike_100n_tmaxms(end) spike_rate_imode_vil_0p8_ith_9p375n_ispike_100n_tmaxms(end) spike_rate_imode_vil_0p7_tmaxms(end) spike_rate_imode_vil_0p775_tmaxms(end) spike_rate_imode_vil_0p9_tmaxms(end)], [ mean(results_linear_maxfold_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_0p7_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_0p775_hsize_242_tmaxms(end,:)) mean(results_linear_maxfold_imode_vil_0p9_hsize_242_tmaxms(end,:))],[ std(results_linear_maxfold_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_0p7_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_0p775_hsize_242_tmaxms(end,:)) std(results_linear_maxfold_imode_vil_0p9_hsize_242_tmaxms(end,:))],'-o','Color','r','LineWidth',3);
