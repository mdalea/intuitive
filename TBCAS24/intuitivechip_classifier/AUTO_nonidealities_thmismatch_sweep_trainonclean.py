...
kfolds=6
runID = 'thmismatch_sweep_trainonclean'

datasetID_clean = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-0-uV2-4'
## THRESHOLD MISMATCH SWEEP --------------------------
#-----------------------------
datasetID = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-1-uV2-4'
...
for fold in range(kfolds):
    os.system(f"CUDA_VISIBLE_DEVICES={cuda} python intuitivespikes_svmclassifier.py --datasetPath ../spikegen/global_outfile/spikegen/ALL_N_{datasetID}-mr_cnt-192-multitrial-Kylberg_filt_6_scan_actualdimscale_chip_lchpf--1to40-1to40_sorted/ --epochs 5 --hidden_size 256 --num_classes 6 --batch_size 32 --tmax_ms 400 --Ts 10 --kfolds 10 --cache yes --svm_window_size 40 --retrainPath SNN_ep-150-isize-2-16-12-hsize-256-bsize-32-lr-0.001-tmax_ms-400.0-Ts-10.0-k-6-dsetPath-ALL_N_{datasetID_clean}-mr_cnt-192-multitrial-Kylberg_filt_6_scan_actualdimscale_chip_lchpf--1to40-1to40_sorted/chip-classifier-test-{fold}-best.pt --retrainPath_id {runID}-{datasetID}-best-{fold}")
#-----------------------------
datasetID = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-100-uV2-4'
...
for fold in range(kfolds):
    os.system(f"CUDA_VISIBLE_DEVICES={cuda} python intuitivespikes_svmclassifier.py --datasetPath ../spikegen/global_outfile/spikegen/ALL_N_{datasetID}-mr_cnt-192-multitrial-Kylberg_filt_6_scan_actualdimscale_chip_lchpf--1to40-1to40_sorted/ --epochs 5 --hidden_size 256 --num_classes 6 --batch_size 32 --tmax_ms 400 --Ts 10 --kfolds 10 --cache yes --svm_window_size 40 --retrainPath SNN_ep-150-isize-2-16-12-hsize-256-bsize-32-lr-0.001-tmax_ms-400.0-Ts-10.0-k-6-dsetPath-ALL_N_{datasetID_clean}-mr_cnt-192-multitrial-Kylberg_filt_6_scan_actualdimscale_chip_lchpf--1to40-1to40_sorted/chip-classifier-test-{fold}-best.pt --retrainPath_id {runID}-{datasetID}-best-{fold}")
#-----------------------------
datasetID = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-10000-uV2-4'
