...
# Texture 180mVpp
#CUDA_VISIBLE_DEVICES=0 python intuitivespikes_svmclassifier.py --datasetPath /users/micas/malea/Documents/ArduinoRead_2/ArduinoRead/out/N_4b_allchannels_ALLCLASS_auto_nospkfilter_cleaned_12x16_180mvpp_250mvofs_onedac/ --epochs 5 --hidden_size 256 --num_classes 6 --batch_size 32 --tmax_ms 400 --Ts 10 --kfolds 6 --cache yes --svm_window_size 40 --retrainPath /users/micas/malea/Documents/intuitivechip_classifier/TrainedALL_epochs-150-input_size-2-16-12-hidden_size-256-batch_size-32-lr-0.001-tmax_ms-400.0-Ts-10.0-kfolds-6-datasetPath-N_4b_allchannels_ALLCLASS_auto_nospkfilter_cleaned_12x16_180mvpp_250mvofs_onedac/chip-classifier-test-0-best.pt

# Vibration
#CUDA_VISIBLE_DEVICES=0 python intuitivespikes_svmclassifier.py --datasetPath /users/micas/malea/Documents/ArduinoRead_2/ArduinoRead/out/N_3b_allchannels_ALLCLASS_auto_nospkfilter_cleaned_12x16_vibration/ --epochs 5 --hidden_size 256 --num_classes 6 --batch_size 32 --tmax_ms 400 --Ts 10 --kfolds 6 --cache yes --svm_window_size 40 --retrainPath /users/micas/malea/Documents/intuitivechip_classifier/TrainedALL_epochs-150-input_size-2-16-12-hidden_size-256-batch_size-32-lr-0.001-tmax_ms-400.0-Ts-10.0-kfolds-6-datasetPath-N_3b_allchannels_ALLCLASS_auto_nospkfilter_cleaned_12x16_vibration/chip-classifier-test-0-best.pt 
