...
#CUDA_VISIBLE_DEVICES=0 python snn_ali_confmat_noslayer_svm_everyepoch.py --datasetPath /users/micas/malea/Documents/ArduinoRead_2/ArduinoRead/out/N_3b_allchannels_18mvpp_250mvofs_ALLclass_auto_nospkfilter_sorted/ --epochs 10 --hidden_size 512 --num_classes 6 --batch_size 12 --tmax_ms 400 --Ts 1 --kfolds 6 --cache yes --svm_window_size 100
...
def test_svm(model, testloader, batch_size, grid_search_linear):
    ...
    print("SVM Test Accuracy @ current epoch: " + str(acc_test_svm))
