...
micasplot; set(gcf, 'Position', [100, 100, 800, 600]); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.fig']); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.png']);
...
ylabel('Classification Performance across 6 folds')
title('vs Hidden Layer Size: Kylberg 6-class Texture Dataset (Vpp = 7.2mVpp, softmax model epoch = 150)')
...
lgd = legend(h,['SNN (rolling window size=40)','-Max. Softmax Accuracy: ',num2str(maxsoft*100),' % @ HiddenLayer=',num2str(hidlayer_arr(Isoft))],['SNN + Linear SVM (rolling window size=40)','-Max. Linear SVM Accuracy: ',num2str(maxlinear*100),' % @ HiddenLayer=',num2str(hidlayer_arr(Ilinear))],['SNN + RBF SVM (rolling window size=40)','-Max. RBF SVM Accuracy: ',num2str(maxrbf*100),' % @ HiddenLayer=',num2str(hidlayer_arr(Irbf))])
lgd.Location = 'southwest';
ylim([0 1])
grid on
micasplot; set(gcf, 'Position', [100, 100, 800, 600]); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.fig']); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.png']);
...
xlabel('Hidden Layer Size')
ylabel('Classification Performance across 6 folds')
title('vs Hidden Layer Size: Kylberg 6-class Texture Dataset (Vpp = 180mVpp, softmax model epoch = 50)')
...
xlabel('Hidden Layer Size')
ylabel('Classification Performance across 6 folds')
title('vs Hidden Layer Size: Kylberg 6-class Texture Dataset (Vpp = 180mVpp, softmax model epoch = 150)')
...
ylabel('Classification Performance across 6 folds')
title('Classification Performance versus Rolling Average Window Size: Kylberg 6-class Texture Dataset')
...
xlabel('Hidden Layer Size')
ylabel('Classification Performance across 6 folds')
title('vs Hidden Layer Size: Flutter frequency (Vpp = 7.2mVpp & 18mVpp, softmax model epoch = 150)')
...
ylabel('Classification Performance across 6 folds')
title('vs Spike bits: Kylberg 6-class Texture Dataset (Model Spikes, Vpp = 7.2mVpp, softmax model epoch = 150)')

%text(14,0.5,['Max. Linear SVM Accuracy: ',max(results_linear_maxfold_hid_arr),' %'])
%text(14,0.5,['Max. RBF SVM Accuracy: ',max(results_rbf_maxfold_hid_arr),' %'])

lgd = legend(h,['SNN (rolling window size=40)','-Max. Softmax Accuracy: ',num2str(maxsoft*100),' % @ N=',num2str(N_arr(Isoft))],['SNN + Linear SVM (rolling window size=40)','-Max. Linear SVM Accuracy: ',num2str(maxlinear*100),' % @ N=',num2str(N_arr(Ilinear))],['SNN + RBF SVM (rolling window size=40)','-Max. RBF SVM Accuracy: ',num2str(maxrbf*100),' % @ N=',num2str(N_arr(Irbf))],['Actual Spikes (Linear SVM) - Max:',num2str(mean(actualspikes_linear)*100),'%'],['Actual Spikes (RBF SVM) - Max:',num2str(mean(actualspikes_rbf)*100),'%'])
lgd.Location = 'southwest';
ylim([0 1])
grid on
micasplot; set(gcf, 'Position', [100, 100, 800, 600]); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.fig']); saveas(gcf,['Kyl6-classifier-',num2str(figi),'.png']);
...
ylabel('Classification Performance across 6 folds')
title('vs Spiking Rate: Kylberg 6-class Texture Dataset (Model Spikes, Vpp = 7.2mVpp, softmax model epoch = 150)')

lgd = legend(h,['SNN (rolling window size=40)','-Max. Softmax Accuracy: ',num2str(maxsoft*100),' % @ SR=',num2str(spikerate_ave(Isoft)),'Hz'],['SNN + Linear SVM (rolling window size=40)','-Max. Linear SVM Accuracy: ',num2str(maxlinear*100),' % @ SR=',num2str(spikerate_ave(Ilinear)),'Hz'],['SNN + RBF SVM (rolling window size=40)','-Max. RBF SVM Accuracy: ',num2str(maxrbf*100),' % @ SR=',num2str(spikerate_ave(Irbf)),'Hz'],['Actual Spikes (Linear SVM) - Max:',num2str(mean(actualspikes_linear)*100),'%'],['Actual Spikes (RBF SVM) - Max:',num2str(mean(actualspikes_rbf)*100),'%'])
lgd.Location = 'southwest';
xlim([1e3 1000e3])
ylim([0 1])
grid on
