...
%
% reads .bs2 files and display histogram of the x,y spike addresses
...
subplot(1,2,1)
histogram(TD_on.x)
title('ON spikes - X addresses')
micasplot
subplot(1,2,2)
histogram(TD_on.y)
title('ON spikes - Y addresses')
micasplot

savefig('histogram_xy_on')

figure
subplot(1,2,1)
histogram(TD_off.x)
title('OFF spikes - X addresses')
micasplot
subplot(1,2,2)
histogram(TD_off.y)
title('OFF spikes - Y addresses')
micasplot

savefig('histogram_xy_off')