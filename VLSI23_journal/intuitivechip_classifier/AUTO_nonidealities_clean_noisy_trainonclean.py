...
kfolds=6
runID = 'clean_noisy_trainonclean'

datasetID_clean = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-0-uV2-4'
## CLEAN
datasetID = 'lcadc-0-uV2-0-uV2-0-uV2-0-mult-0-uV2-4'
...
#-----------------------------
## NOISY (AFE white + flicker noise, threshold noise + mismatch)
datasetID = 'lcadc-0-uV2-100-uV2-100-uV2-1-mult-0.01-uV2-4'
