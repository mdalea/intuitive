...
%     [mean_ser_vmode_N2b_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
%     mean_ser_vmode_N2b_corr_tmaxms(s,:) = mean_ser_vmode_N2b_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);
...
%      [mean_ser_vmode_N3b_180mvpp_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
%     mean_ser_vmode_N3b_180mvpp_tmaxms(s,:) = mean_ser_vmode_N3b_180mvpp_tmaxms(s,:) ./ (1e-3*tmax_ms);
% 
...
%     [mean_ser_vmode_N4b_180mvpp_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
%     mean_ser_vmode_N4b_180mvpp_tmaxms(s,:) = mean_ser_vmode_N4b_180mvpp_tmaxms(s,:) ./ (1e-3*tmax_ms);
% 
...
%     [mean_ser_vmode_N5b_180mvpp_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
%     mean_ser_vmode_N5b_180mvpp_tmaxms(s,:) = mean_ser_vmode_N5b_180mvpp_tmaxms(s,:) ./ (1e-3*tmax_ms);
...
%VMODE (CORR)    (180mvpp) 
    ...
    [mean_ser_vmode_N2b_180mvpp_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
    mean_ser_vmode_N2b_180mvpp_corr_tmaxms(s,:) = mean_ser_vmode_N2b_180mvpp_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);
    ...
    [mean_ser_vmode_N3b_180mvpp_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
    mean_ser_vmode_N3b_180mvpp_corr_tmaxms(s,:) = mean_ser_vmode_N3b_180mvpp_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);
    ...
    [mean_ser_vmode_N4b_180mvpp_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
    mean_ser_vmode_N4b_180mvpp_corr_tmaxms(s,:) = mean_ser_vmode_N4b_180mvpp_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);
    ...
    [mean_ser_vmode_N5b_180mvpp_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
    mean_ser_vmode_N5b_180mvpp_corr_tmaxms(s,:) = mean_ser_vmode_N5b_180mvpp_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);     
...
%     [mean_ser_imode_vil_0p85_180mvpp_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
%     mean_ser_imode_vil_0p85_180mvpp_tmaxms(s,:) = mean_ser_imode_vil_0p85_180mvpp_tmaxms(s,:) ./ (1e-3*tmax_ms);    
% 
...
%     mean_ser_imode_vil_1_180mvpp_tmaxms(s,:) = mean_ser_imode_vil_1_180mvpp_tmaxms(s,:) ./ (1e-3*tmax_ms);
 ...
 %IMODE (180mvpp) (CORR)
    ...
    [mean_ser_imode_vil_0p85_180mvpp_corr_tmaxms(s,:)]=get_metric(datasetPath,"mean_ser")
    mean_ser_imode_vil_0p85_180mvpp_corr_tmaxms(s,:) = mean_ser_imode_vil_0p85_180mvpp_corr_tmaxms(s,:) ./ (1e-3*tmax_ms);   
