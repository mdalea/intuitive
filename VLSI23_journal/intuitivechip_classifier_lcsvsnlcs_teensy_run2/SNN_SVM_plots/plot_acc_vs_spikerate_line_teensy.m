...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_tmaxms(end)], [ mean(max_imode_vil_0p8_hsize_242_tmaxms(end,:)) ],[ std(max_imode_vil_0p8_hsize_242_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);
...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_tmaxms(end)], [ mean(svm_maxfold_imode_vil_0p8_hsize_242_tmaxms(end,:)) ],[ std(svm_maxfold_imode_vil_0p8_hsize_242_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);
...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_corr_tmaxms(end)], [ mean(max_imode_vil_0p8_hsize_242_corr_tmaxms(end,:)) ],[ std(max_imode_vil_0p8_hsize_242_corr_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);
...
h(end+1)=errorbar([spike_rate_imode_vil_0p8_corr_tmaxms(end)], [ mean(svm_maxfold_imode_vil_0p8_hsize_242_corr_tmaxms(end,:)) ],[ std(svm_maxfold_imode_vil_0p8_hsize_242_corr_tmaxms(end,:)) ],'-o','Color','black','LineWidth',3);

% h(end+1)=errorbar([spike_rate_imode_vil_0p7_ith_9p375n_ispike_100n_corr_tmaxms(end) spike_rate_imode_vil_0p8_ith_9p375n_ispike_100n_corr_tmaxms(end) spike_rate_imode_vil_0p7_corr_tmaxms(end) spike_rate_imode_vil_0p775_corr_tmaxms(end) spike_rate_imode_vil_0p9_corr_tmaxms(end)], [ mean(svm_maxfold_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_corr_tmaxms(end,:)) mean(svm_maxfold_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_corr_tmaxms(end,:)) mean(svm_maxfold_imode_vil_0p7_hsize_242_corr_tmaxms(end,:)) mean(svm_maxfold_imode_vil_0p775_hsize_242_corr_tmaxms(end,:)) mean(svm_maxfold_imode_vil_0p9_hsize_242_corr_tmaxms(end,:))],[ std(svm_maxfold_imode_vil_0p7_ith_9p375n_ispike_100n_hsize_242_corr_tmaxms(end,:)) std(svm_maxfold_imode_vil_0p8_ith_9p375n_ispike_100n_hsize_242_corr_tmaxms(end,:)) std(svm_maxfold_imode_vil_0p7_hsize_242_corr_tmaxms(end,:)) std(svm_maxfold_imode_vil_0p775_hsize_242_corr_tmaxms(end,:)) std(svm_maxfold_imode_vil_0p9_hsize_242_corr_tmaxms(end,:))],'-o','Color','r','LineWidth',3);
